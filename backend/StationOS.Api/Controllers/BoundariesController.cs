...
public class BoundariesController : ControllerBase
{
    ...
    /// <summary>Tạo boundary mới cho camera. Gọi từ Frontend hoặc AI Engine (internal).</summary>
    ...
    /// <summary>Xóa boundary. Gọi từ Frontend hoặc AI Engine (internal).</summary>
